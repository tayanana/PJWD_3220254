  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {message && (
        ...
        >
          <svg 
            className={`h-5 w-5 ${message.includes('successful') ? 'text-green-400' : 'text-red-400'}`} 
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center space-x-2"
      >
        {isLoading ? (
          <>
